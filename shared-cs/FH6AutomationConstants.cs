namespace FH6AutomationShared
{
    internal static class FH6AutomationConstants
    {
        ...
        internal static class SkillPoints
        {
            ...
            public const int MinuteLoopGain = 50;
            public const int DefaultBlueprintNetTimeMs = 101000;
            public const int MinuteLoopEnterToXWaitMs = 115000;
            public const int MinuteLoopAfterXWaitMs = Timing.OneSecondMs;
            public const int MinuteLoopEstimatedFixedMs = 25300;
            public const int MinuteLoopEstimatedLoopMs = DefaultBlueprintNetTimeMs + MinuteLoopEstimatedFixedMs;
        }
